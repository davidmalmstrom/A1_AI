public class MyFunctions {
    public static double[][] alphaPass(double[][] piVector, int N, int T, double[][] B, int[] obsList, double[][] A, boolean scaling) {
    ...
    public static double[][] betaPass(int N, int T, double[][] B, int[] obsList, double[][] A) {
        double[][] beta = new double[T][N];
        for (int t = T - 2; t > -1; t--) { //möjligt fel
            for (int i = 0; i < N; i++) {
                beta[t][i] = 0;
                for (int j = 0; j < N; j++) {
